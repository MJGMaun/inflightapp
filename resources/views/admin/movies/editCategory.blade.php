...
<div class="d-flex align-items-center pb-2 mb-3 border-bottom">
    <a href="/admin/movies/createCategory">Create Categories</a> &nbsp; <span data-feather="chevron-right"></span> &nbsp;{{$category->movie_category_name}}
</div>
{!! Form::open(['action' => ['Admin\MoviesController@updateCategory', $category->id ], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    ...
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item center text-center">
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    {{Form::text('category', $category->movie_category_name, ['class' => 'form-control', 'placeholder' => 'Enter Category Name'])}}
                </div>
            </div>
        </li>
        <li class="list-group-item center text-center">
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                     {{Form::number('moviePriceEWallet', $movieCategoryPriceEWallet, ['class' => 'form-control', 'placeholder' => 'Enter Category E-Wallet Price'])}}
                </div>
            </div>
        </li>
        <li class="list-group-item center text-center">
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    {{Form::number('moviePriceToken', $movieCategoryPriceToken, ['class' => 'form-control', 'placeholder' => 'Enter Category Token Price'])}}
                </div>
            </div>
        </li>
        <li class="list-group-item center text-center">
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    {{Form::textarea('description', $category->movie_category_description, ['class' => 'form-control', 'placeholder' => 'Enter Category Description'])}}
                </div>
            </div>
        </li>
